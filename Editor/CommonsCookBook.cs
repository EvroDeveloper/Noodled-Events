...
public class CommonsCookBook : CookBook
{
    public override void CollectDefs(List<NodeDef> allDefs)
    {
        ...
        allDefs.Add(new NodeDef(this, "vars.get_bowl_float_var",
    ...
    private void Compile_wait(UltEventBase evt, SerializedNode node, Transform dataRoot)
    {
    ...
    private void Compile_if(UltEventBase evt, SerializedNode node, Transform dataRoot)
    {
        ...
        if (node.DataInputs[0].Source == null)
        {
            ...
            if (next.Target != null)
                next.Target.Node.compileAction.Invoke((node.DataInputs[0].DefaultBoolValue ? onTrue : onFalse).EnableEvent, next.Target.Node, dataRoot);
        }
        else // condition varies
        {
            ...
            if (next.Target != null)
                next.Target.Node.compileAction.Invoke(onTrue.EnableEvent, nextNode, dataRoot);
            next = node.FlowOutputs[1];
            if (next.Target != null)
                next.Target.Node.compileAction.Invoke(onFalse.EnableEvent, nextNode, dataRoot);
        }
    }

    private void Compile_add_floats(UltEventBase evt, SerializedNode node, Transform dataRoot)
    {
        MethodInfo v3Mult = typeof(Vector3).GetMethod("op_Multiply", UltEventUtils.AnyAccessBindings, null, new Type[] { typeof(Vector3), typeof(float) }, null);
        var makeA = new PersistentCall(v3Mult, null);
        makeA.PersistentArguments[0].Vector3 = new Vector3(0, 1, 0);
        ...
        var nextNode = node.FlowOutputs[0].Target?.Node;
        if (nextNode != null)
            nextNode.compileAction.Invoke(evt, nextNode, dataRoot);
    }

    private void Compile_sub_floats(UltEventBase evt, SerializedNode node, Transform dataRoot)
    {
        MethodInfo v3Mult = typeof(Vector3).GetMethod("op_Multiply", UltEventUtils.AnyAccessBindings, null, new Type[] { typeof(Vector3), typeof(float) }, null);
    ...
    private void Compile_mul_floats(UltEventBase evt, SerializedNode node, Transform dataRoot)
    {
        MethodInfo v3Mult = typeof(Vector3).GetMethod("op_Multiply", UltEventUtils.AnyAccessBindings, null, new Type[] { typeof(Vector3), typeof(float) }, null);
        var makeA = new PersistentCall(v3Mult, null);
        makeA.PersistentArguments[0].Vector3 = new Vector3(0, 1, 0);
    ...
    private void Compile_div_floats(UltEventBase evt, SerializedNode node, Transform dataRoot)
    {
        MethodInfo v3Mult = typeof(Vector3).GetMethod("op_Multiply", UltEventUtils.AnyAccessBindings, null, new Type[] { typeof(Vector3), typeof(float) }, null);
    ...
    private void Compile_greater(UltEventBase evt, SerializedNode node, Transform dataRoot)
    {
    ...
    private void Compile_lesser(UltEventBase evt, SerializedNode node, Transform dataRoot)
    {
